...
module.exports = app => {
  class MonthServer extends app.Service {
    ...
    * list(pageNum, pageSize) {
      const articles = yield app.mysql.query('select  video_recommand.id,video_id,video_video.name, datetime from video_recommand left join video_video on video_recommand.video_id = video_video.id order by video_recommand.datetime desc limit ? offset ?;', [ pageSize, (pageNum - 1) * pageSize ]);
      return articles;
    }
